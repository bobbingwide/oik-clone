...
= 2.0.0 = 
* Fixed: Re-unicodify serialised attributes,[github bobbingwide oik-clone issues 52]
* Tested: With WordPress 5.6-RC2 and WordPress Multi Site
* Tested: With Gutenberg 9.4.1
* Tested: With PHP 7.4

= 2.0.0-beta-20200616 = 
* Added: Reclone logic run immediately after cloning content,[github bobbingwide oik-clone issues 50]
...
= 2.0.0-beta-20200127 = 
* Added: Clone admin Slave tab to reconcile content and/or clone new content between master and slave,[github bobbingwide oik-clone issues 49]
...
= 2.0.0-beta-20191121 = 
* Changed: map the ref attr used in the reusable blocks block,[github bobbingwide oik-clone issues 38]
* Changed: Only expand clone/cloned shortcodes when just one thing is being displayed, [github bobbingwide oik-clone issues 43]
...
= 2.0.0-beta-20191008 = 
* Added: Do Not Clone meta box and logic to selectively restrict cloning to slaves,[github bobbingwide oik-clone issues 37]
* Tested: With WordPress 5.2.3 and WordPress Multi Site
* Tested: With WordPress 5.3-beta2 as a server
* Tested: With PHP 7.3

= 2.0.0-beta-20190811 =
* Changed: Add support for productID parameter in shortcodes,[github bobbingwide oik-clone issues 38]
...
* Fixed: Allow for terms where the slug matches the term_id. e.g. when name is &amp;,[github bobbingwide oik-clone issues 33]

= 2.0.0-alpha-20190602 =
* Added: Add logic to pull (new) posts from the slave that haven't been cloned from the master, [github bobbingwide oik-clone issues 34]
...
* Changed: Improve MS pull logic to perform mapping and create target folder for attachments., [github bobbingwide oik-clone issues 29]
* Fixed: Avoid messages for corrupted cloning data. Doesn't prevent / fix the corrupted data., [github bobbingwide oik-clone issues 14]
* Fixed: Support listing of all posts in hierarchical/inherited post types in oik-clone admin MultiSite tab
* Fixed: cURL error 60 in local WPMS., [github bobbingwide oik-clone issue 30]
* Tested: With Gutenberg 5.3.0

= 1.1.0 =
* Changed: Update oik-clone admin MultiSite tab [github bobbingwide oik-clone issues 28]
* Changed: Update MultiSite pull logic for attachments [github bobbingwide oik-clone issues 29]
* Tested: With WordPress 5.1.1
* Tested: With PHP 7.2
* Tested: With Gutenberg 5.1.1

= 1.0.2 = 
* Fixed: Convert links correctly - don't lose the scheme, [github bobbingwide oik-clone issues 26] 

= 1.0.1 = 
* Fixed: when creating new content call wp_slash to avoid losing backslashes, [github bobbingwide oik-clone issues 22]
* Changed: Use oik_remote class, replaces oik-remote.inc, [github bobbingwide oik-clone issues 24]
* Fixed: Enable cloning of Block icons by removing kses filters in the server [github bobbingwide oik-clone issues 24]
* Tested: With WordPress 5.0.3
* Tested: With PHP 7.2

= 1.0.0 = 
* Added: Batch facility to reload cloning information on an imported database, [github bobbingwide oik-clone issue 17]
* Changed: Attempt to cater for corrupt data, with some trace changes for problem determination [github bobbingwide oik-clone issue 14]
* Changed: Now depends on oik v3.2.1 [github bobbingwide oik-clone issues 21]
* Fixed: Some [bw_link] shortcodes are being mapped to Array [github bobbingwide oik-clone issue 13]
* Tested: With PHP 7.0 and 7.1
* Tested: With WordPress 4.9 and WordPress Multisite 

= 1.0.0-RC2 = 
* Fixed: Using [clone] failed to upload attached files [github bobbingwide oik-clone issue 9]
* Fixed: Notice: Array to string conversion [github bobbingwide oik-clone issue 11]
* Fixed: Using [clone] to clone attached media that's been relocated doesn't work correctly. [github bobbingwide oik-clone issue 12]
